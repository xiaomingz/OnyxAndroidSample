...
public class ImplicitIntentsUtil {
    ...
    public static Intent composeQuickContactIntent(Context context, Uri contactLookupUri,
        ...
        ComponentName componentName = new ComponentName("com.android.contacts", "com.android.contacts.quickcontact.QuickContactActivity");
        ...
        // Make sure not to show QuickContacts on top of another QuickContacts.
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra(EXTRA_PREVIOUS_SCREEN_TYPE, previousScreenType);
        return intent;
    }
}
