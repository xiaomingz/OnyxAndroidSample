...
public class MimeTypeUtils {
    ...
    public static final List<String> readerSupportFormatExtension =
            Arrays.asList("azw", "azw3", "cbz", "cbr", "chm", "djvu", "doc", "docm", "docx", "epub", "fb2", "fbz",
                    "mobi", "jeb", "jdnovel", "odt", "pdb", "pdf", "prc", "rtf", "sxw", "tif", "tiff", "trc", "txt",
                    "zip", "jpeg", "jpg", "png", "bmp", "xml", "html");
    ...
    public static boolean isCanOpenWithNeoReader(String path) {
        ...
        if (readerSupportFormatExtension.contains(extension)) {
            return true;
        }
    ...
    public static boolean isImage(String filePath) {
        String fileMimeType = ViewDocumentUtils.getFileMimeType(new File(filePath));
        if (StringUtils.isNullOrEmpty(fileMimeType)) {
            return false;
        }
        return isImageType(fileMimeType);
    }
}
