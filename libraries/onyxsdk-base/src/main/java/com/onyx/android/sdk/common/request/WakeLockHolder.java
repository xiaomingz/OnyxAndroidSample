...
public class WakeLockHolder {
    private static final String UNIVERSAL_TAG = "onyx-framework";
    ...
    public final static int WAKEUP_FLAGS = PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.ON_AFTER_RELEASE;
    ...
    public synchronized void acquireInfiniteWakeLock(final Context context) {
        acquireWakeLock(context, UNIVERSAL_TAG);
    }
