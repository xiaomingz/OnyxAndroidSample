...
public class PageInfo {
    ...
    private RectF contentRect = new RectF(); // page content rect in page screen coordinates system with actual scale
    private RectF visibleRectInContent = new RectF(); // page visible rect in content rect coordinates system with actual scale
    private float actualScale = PageConstants.DEFAULT_ACTUAL_SCALE;
    ...
    public static PageInfo copyWithSubPage(PageInfo pageInfo) {
        ...
        info.setSubPage(pageInfo.getSubPage());
        return info;
    }
    ...
    public PageInfo(final PageInfo pageInfo) {
        ...
        contentRect.set(pageInfo.contentRect);
        visibleRectInContent.set(pageInfo.visibleRectInContent);
        actualScale = pageInfo.actualScale;
        specialScale = pageInfo.specialScale;
        isTextPage = pageInfo.isTextPage;
        extraKey = pageInfo.extraKey;
    }
    ...
    public PageInfo setSpecialScale(int specialScale) {
        this.specialScale = specialScale;
        return this;
    }
    ...
    public RectF getVisibleRectInContent() {
        return visibleRectInContent;
    }

    public PageInfo setVisibleRectInContent(RectF visibleRectInContent) {
        this.visibleRectInContent = visibleRectInContent;
        return this;
    }
