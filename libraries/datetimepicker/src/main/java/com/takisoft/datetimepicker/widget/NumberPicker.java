...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 0;//R.layout.number_picker_material;
    ...
    private static class TwoDigitFormatter implements NumberPicker.Formatter {
        ...
        private static char getZeroDigit(Locale locale) {
            return DecimalFormatSymbols.getInstance(locale).getZeroDigit(); // FIXME needs ICU
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int[] PRESSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_PRESSED);
    ...
    // FIXME this is here as a placeholder, this value should come from View.isVisibleToUser()
    private boolean isVisibleToUser() {
        return false;
    }

    // FIXME this is here as a placeholder, this value should come from View.isVisibleToUser(rect)
    private boolean isVisibleToUser(Rect rect) {
        return false;
    }

    // FIXME this is here as a placeholder, should call View.requestAccessibilityFocus()
    private void requestAccessibilityFocus() {

    }

    // FIXME this is here as a placeholder, should call View.clearAccessibilityFocus()
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        private AccessibilityManager accessibilityManager = (AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE);
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        ...
                        return false;
                        default: {
                            return ViewCompat.performAccessibilityAction(mInputText, action, arguments);
