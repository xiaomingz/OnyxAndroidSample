...
import com.takisoft.datetimepicker.widget.RadialTimePickerView.OnValueSelectedListener;
import com.takisoft.datetimepicker.widget.TextInputTimePickerView.OnValueTypedListener;
import com.takisoft.datetimepicker.widget.internal.NumericTextView;
import com.takisoft.datetimepicker.widget.internal.NumericTextView.OnValueChangedListener;
...
//                mRadialTimePickerHeader.setBackgroundDrawable(a.getDrawable(R.styleable.TimePicker_headerBackground));
        ...
        mRadialTimePickerHeader.setBackgroundColor(a.getResources().getColor(R.color.timepicker_default_text_color_material));
        a.recycle();
    ...
    private void toggleRadialPickerMode() {
        ...
        mRadialTimePickerModeButton.setVisibility(View.GONE);
    }
