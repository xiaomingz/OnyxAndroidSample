...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs,
        ...
        if (isAmPmAtStart()) {
            ...
            final int startMargin = MarginLayoutParamsCompat.getMarginStart(lp);//lp.getMarginStart();
            final int endMargin = MarginLayoutParamsCompat.getMarginEnd(lp);//lp.getMarginEnd();
            if (startMargin != endMargin) {
                MarginLayoutParamsCompat.setMarginStart(lp, endMargin);
                MarginLayoutParamsCompat.setMarginEnd(lp, startMargin);
        ...
        if (ViewCompat.getImportantForAccessibility(mDelegator) == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
            ViewCompat.setImportantForAccessibility(mDelegator, ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);
        }
