...
class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
    ...
    private void reorderSpinners() {
        ...
        //String pattern = DateFormatFix.getBestDateTimePattern(mSpinners.getContext(), Locale.getDefault(), "yyyyMMMdd");
        char[] order = DateFormatFix.getDateFormatOrder(mSpinners.getContext(), Locale.getDefault(), "yyyyMMMdd");
    ...
    private void updateInputState() {
        ...
        // FIXME InputMethodManager inputMethodManager = InputMethodManager.peekInstance();
