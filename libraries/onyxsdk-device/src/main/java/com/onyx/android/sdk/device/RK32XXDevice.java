...
public class RK32XXDevice extends BaseDevice {
    ...
    private static Method sMethodApplyToggleA2Mode = null;
    ...
    public static RK32XXDevice createDevice() {
        if (sInstance == null) {
            ...
            int value_mode_dither = ReflectUtil.getStaticIntFieldSafely(viewUpdateHelperClass, "EINK_DITHER_MODE_DITHER");
            ...
            sMethodApplyToggleA2Mode = ReflectUtil.getMethodSafely(cls, "toggleA2Mode");
            ...
            Debug.d(RK32XXDevice.class, "init device finished.");
            return sInstance;
        }
        return sInstance;
    }
    ...
    public void applySystemFastMode(boolean enable) {
        ReflectUtil.invokeMethodSafely(sMethodApplyToggleA2Mode, null);
    }
    ...
    public ComponentName getCurrentTopComponent(Context context) {
        ...
        if (result != null && result instanceof ComponentName) {
