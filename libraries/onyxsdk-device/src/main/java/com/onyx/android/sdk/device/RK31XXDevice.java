...
public class RK31XXDevice extends BaseDevice {
    ...
    public static RK31XXDevice createDevice() {
        if (sInstance == null) {
            ...
            sMethodHasFrontLight = ReflectUtil.getMethodSafely(deviceControllerClass, "hasFLBrightness", Context.class);
            sMethodHasBluetooth = ReflectUtil.getMethodSafely(deviceControllerClass, "hasBluetooth", Context.class);
            sMethodHasNaturalBrightness = ReflectUtil.getMethodSafely(deviceControllerClass, "hasCTMBrightness", Context.class);
    ...
    public int getFrontLightDeviceValue(Context context) {
        return getColdLightConfigValue(context);
    }
    ...
    public boolean hasFLBrightness(Context context) {
        Boolean result = (Boolean) this.invokeDeviceControllerMethod(context, sMethodHasFrontLight, context);
        return result == null ? false : result;
    }
    ...
    public boolean hasCTMBrightness(Context context) {
        Boolean result = (Boolean) this.invokeDeviceControllerMethod(context, sMethodHasNaturalBrightness, context);
        return result == null ? false : result;
    }
    ...
    public Integer[] getColdLightValues(Context context) {
        ...
        if (values.length == 1) {
            // keep compatibility with non-natural light devices
            return values[0];
        }
