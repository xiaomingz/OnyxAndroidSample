...
public class SDMDevice extends BaseDevice {
    private static final String TAG = SDMDevice.class.getSimpleName();

    private static SDMDevice sInstance = null;

    private static int sPolicyAutomatic = 0;
    private static int sPolicyGUIntervally = 0;

    private static int sModeDW = 0;
    private static int sModeDWQuality = 0;
    ...
    private static int sModeAnimationMono = 0;
    private static int sModeAnimationX = 0;
    ...
    private static int sModeHandWritingMode = 0;
    ...
    private static Method sMethodHandwritingRepaint = null;
    ...
    private static Method sMethodIsLightOn;
    private static Method sMethodGetSystemConfigPrefix;


    private static Method sMethodGetCurrentTopComponent;
    private static Method sMethodGetRunningTasksWithoutPermissionCheck;
    private static Method sMethodGetEACAppConfigStringByPkgName;

    private static Method sMethodSetTaskWindowingModeSplitScreenPrimary;
    private static Method sMethodDismissSplitScreenMode;
    private static Method sMethodResizeDockedStack;
    private static Method sMethodGetTaskBounds;
    private static Method sMethodGetTaskWindowingMode;
    private static Method sMethodSetDockedStackCreateState;
    private static Method sMethodIsSystemInMultiWindowMode;

    private static Method sMethodSetRotationLockAtAngle;
    private static Method sMethodIsOECEnable;
    private static Method sMethodGetGlobalContrast;
    private static Method sMethodGetSystemRefreshMode;

    private static Method sMethodsSetSystemProperties;
    private static Method sMethodsGetSystemProperties;

    private static Method sMethodsGetAppActiveNotificationsCount;
    ...
    public static SDMDevice createDevice() {
        if (sInstance == null) {
            ...
            sModeDWQuality = ReflectUtil.getStaticIntFieldSafely(viewUpdateHelperClass, "UI_DU_QUALITY_MODE");
            ...
            sModeAnimationMono = ReflectUtil.getStaticIntFieldSafely(viewUpdateHelperClass, "UI_MONO_A2_MODE");
            sModeAnimationX = ReflectUtil.getStaticIntFieldSafely(viewUpdateHelperClass, "UI_X_A2_MODE");
            ...
            sModeHandWritingMode = ReflectUtil.getStaticIntFieldSafely(viewUpdateHelperClass, "HAND_WRITING_REPAINT_MODE");
            sMethodIsOECEnable = ReflectUtil.getMethodSafely(viewUpdateHelperClass, "isOECEnable");

            Class constantClass = ReflectUtil.classForName("android.onyx.optimization.Constant");
            UPDATE_MODE_DEFAULT = ReflectUtil.getStaticIntFieldSafely(constantClass, "UPDATE_MODE_DEFAULT");
            UPDATE_MODE_DU = ReflectUtil.getStaticIntFieldSafely(constantClass, "UPDATE_MODE_DU");
            UPDATE_MODE_A2 = ReflectUtil.getStaticIntFieldSafely(constantClass, "UPDATE_MODE_A2");
            UPDATE_MODE_REGAL = ReflectUtil.getStaticIntFieldSafely(constantClass, "UPDATE_MODE_REGAL");
            UPDATE_MODE_X = ReflectUtil.getStaticIntFieldSafely(constantClass, "UPDATE_MODE_X");
            ...
            sMethodHandwritingRepaint = ReflectUtil.getMethodSafely(cls, "handwritingRepaint", View.class, int.class, int.class, int.class, int.class);
            ...
            sMethodsGetSystemProperties = ReflectUtil.getMethodSafely(deviceControllerClass, "getSystemProperties", String.class);
            sMethodsSetSystemProperties = ReflectUtil.getMethodSafely(deviceControllerClass, "setSystemProperties", String.class, String.class);
            ...
            sMethodIsLightOn = ReflectUtil.getMethodSafely(deviceControllerClass, "isLightOn", int.class);
            sMethodGetSystemConfigPrefix  = ReflectUtil.getMethodSafely(deviceControllerClass, "getSystemConfigPrefix", Context.class);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                ...
                sMethodDumpCTPInfo = ReflectUtil.getMethodSafely(InputManager.class, "dumpInfo");
            }
            ...
            sMethodToggleToA2Mode = ReflectUtil.getMethodSafely(cls, "toggleA2Mode");
            ...
            sMethodGetGlobalContrast = ReflectUtil.getMethodSafely(eInkHelperClass,
                    "getGlobalContrast");
            sMethodGetSystemRefreshMode = ReflectUtil.getMethodSafely(eInkHelperClass, "getSystemRefreshMode");
            ...
            sMethodGetRunningTasksWithoutPermissionCheck = ReflectUtil.getMethodSafely(ActivityManager.class, "getRunningTasksWithoutPermissionCheck", int.class);

            sMethodSetTaskWindowingModeSplitScreenPrimary = ReflectUtil.getMethodSafely(ActivityManager.class,
                    "setTaskWindowingModeSplitScreenPrimary", int.class, int.class, boolean.class, boolean.class, Rect.class, boolean.class);
            sMethodDismissSplitScreenMode = ReflectUtil.getMethodSafely(ActivityManager.class,"dismissSplitScreenMode", boolean.class);
            sMethodResizeDockedStack = ReflectUtil.getMethodSafely(ActivityManager.class,"resizeDockedStack", Rect.class, Rect.class, Rect.class, Rect.class, Rect.class);
            sMethodGetTaskBounds = ReflectUtil.getMethodSafely(ActivityManager.class,"getTaskBounds", int.class);
            sMethodGetTaskWindowingMode = ReflectUtil.getMethodSafely(ActivityManager.class,"getTaskWindowingMode", int.class);
            sMethodSetDockedStackCreateState = ReflectUtil.getMethodSafely(ActivityManager.class,"setDockedStackCreateState", int.class, Rect.class);
            sMethodIsSystemInMultiWindowMode = ReflectUtil.getMethodSafely(ActivityManager.class, "isSystemInMultiWindowMode");

            Class<?> rotationPolicyClass = ReflectUtil.classForName("com.android.internal.view.RotationPolicy");
            sMethodSetRotationLockAtAngle = ReflectUtil.getMethodSafely(rotationPolicyClass,"setRotationLockAtAngle", Context.class, boolean.class, int.class);

            sMethodsGetAppActiveNotificationsCount = ReflectUtil.getMethodSafely(NotificationManager.class, "getAppActiveNotificationsSize", String.class);
            Debug.d(SDMDevice.class, "init device finished.");
            return sInstance;
        }
        return sInstance;
    }
    ...
    public boolean saveSystemConfig(Context context, String key, String value) {
        Boolean result = (Boolean) this.invokeDeviceControllerMethod(context, sMethodSaveSystemConfig, key, value);
    ...
    int getUpdateMode(UpdateMode mode) {
        ...
        switch (mode) {
            ...
            case ANIMATION_QUALITY:
                ...
                break;
            case ANIMATION_MONO:
                dst_mode = sModeAnimationMono;
                break;
            case ANIMATION_X:
                dst_mode = sModeAnimationX;
                break;
            case GC4:
                dst_mode = sModeGC4;
                break;
            ...
            case REGAL_D:
                ...
                break;
            case HAND_WRITING_REPAINT_MODE:
                dst_mode = sModeHandWritingMode;
                break;
            default:
    ...
    public void toggleA2Mode() {
        ReflectUtil.invokeMethodSafely(sMethodToggleToA2Mode,null);
    }
    ...
    public boolean isHallControlEnable(Context context) {
        Boolean result = (Boolean) this.invokeDeviceControllerMethod(context, sMethodIsHallControlEnable);
        return result == null ? false : result;
    }
    ...
    public void handwritingRepaint(View view, int left, int top, int right, int bottom) {
        ReflectUtil.invokeMethodSafely(sMethodHandwritingRepaint, null, view, left, top, right, bottom);
    }
    ...
    public ComponentName getCurrentTopComponent(Context context) {
        Object result = ReflectUtil.invokeMethodSafely(sMethodGetCurrentTopComponent, null, context);
    ...
    public List<ActivityManager.RunningTaskInfo> getRunningTasksWithoutPermissionCheck(Context context, int maxNum) {
        try {
            return (List<ActivityManager.RunningTaskInfo>) ReflectUtil.invokeMethodSafely(sMethodGetRunningTasksWithoutPermissionCheck, getActivityManager(context), maxNum);
        } catch (Exception e) {
            Debug.w(e);
        }
    ...
    public boolean isBrightnessOn(Context context) {
        return isLightOn(context);
    }

    @Override
    public boolean isLightOn(Context context) {
        return isLightOn(context, LIGHT_TYPE_CTM_ALL);
    }
    ...
    public boolean isLightOn(Context context, int type) {
        ...
        Boolean value = (Boolean) ReflectUtil.invokeMethodSafely(sMethodIsLightOn, null, type);
        if (value == null) {
            return false;
        }
        return value;
    ...
    public void configLightStatusBar(Window window) {
        ReflectUtil.setDeclareIntFieldSafely("com.android.internal.policy.DecorView",
                window.getDecorView(), "mSemiTransparentStatusBarColor", Color.WHITE);
        int systemUIVisibilityFlag = View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            window.setNavigationBarColor(Color.WHITE);
            systemUIVisibilityFlag = View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_LIGHT_NAVIGATION_BAR;
        }
        window.getDecorView()
                .setSystemUiVisibility(systemUIVisibilityFlag);
    }
    ...
    public void setTaskWindowingModeSplitScreenPrimary(Context context, int taskId, int createMode) {
        ...
        boolean showRecents = false;
        setTaskWindowingModeSplitScreenPrimary(context, taskId,createMode, toTop, animate, initialBounds, showRecents);
    }

    private void setTaskWindowingModeSplitScreenPrimary(Context context, int taskId, int createMode, boolean toTop,
                                                               boolean animate, Rect initialBounds, boolean showRecents) {
        ReflectUtil.invokeMethodSafely(sMethodSetTaskWindowingModeSplitScreenPrimary, getActivityManager(context),
                taskId, createMode, toTop, animate, initialBounds, showRecents);
    }

    @Override
    public void dismissSplitScreenMode(Context context, boolean toTop) {
        ReflectUtil.invokeMethodSafely(sMethodDismissSplitScreenMode, getActivityManager(context), toTop);
    }

    @Override
    public void setRotationLockAtAngle(Context context, final boolean enabled, final int rotation) {
        ReflectUtil.invokeMethodSafely(sMethodSetRotationLockAtAngle, null, context, enabled, rotation);
    }
    ...
    public void resizeDockedStack(Context context,
        ...
        ReflectUtil.invokeMethodSafely(sMethodResizeDockedStack, getActivityManager(context)
                , dockedBounds, tempDockedTaskBounds
    ...
    public Rect getTaskBounds(Context context, int taskId) {
        return (Rect) ReflectUtil.invokeMethodSafely(sMethodGetTaskBounds, getActivityManager(context), taskId);
    }

    @Override
    public int getTaskWindowingMode(Context context, int taskId) {
        return (int) ReflectUtil.invokeMethodSafely(sMethodGetTaskWindowingMode, getActivityManager(context), taskId);
    }

    @Override
    public void setDockedStackCreateState(Context context, int mode, Rect bounds) {
        ReflectUtil.invokeMethodSafely(sMethodSetDockedStackCreateState, getActivityManager(context), mode, bounds);
    }

    @Override
    public boolean isSystemInMultiWindowMode(Context context) {
        Boolean result = (Boolean) ReflectUtil.invokeMethodSafely(sMethodIsSystemInMultiWindowMode, getActivityManager(context));
        return result == null ? false : result;
    }

    @Override
    public String getSystemConfigPrefix(Context context) {
        Object value = ReflectUtil.invokeMethodSafely(sMethodGetSystemConfigPrefix, null, context);
    ...
    public boolean isOECEnable() {
        Object value = ReflectUtil.invokeMethodSafely(sMethodIsOECEnable, null);
    ...
    public int getGlobalContrast() {
        Object value = ReflectUtil.invokeMethodSafely(sMethodGetGlobalContrast, null);
    ...
    public void setSystemProperties(String key, String value) {
        this.invokeDeviceControllerMethod(null, sMethodsSetSystemProperties, key, value);
    }

    @Override
    public String getSystemProperties(String key) {
        Object result = this.invokeDeviceControllerMethod(null, sMethodsGetSystemProperties, key);
        if (result == null || result.equals("")) {
            return "";
        }
        return result.toString();
    ...
    public int getSystemRefreshMode() {
        Object value = ReflectUtil.invokeMethodSafely(sMethodGetSystemRefreshMode, null);
        if (value instanceof Integer) {
            return (Integer) value;
        }
        return 0;
    ...
    public void dumpCTPInfo(Context context) {
        ReflectUtil.invokeMethodSafely(sMethodDumpCTPInfo, getInputManager(context));
    }
    ...
    public int getAppActiveNotificationsCount(Context context, String pkg) {
        ...
        int size = 0;
        Object value = ReflectUtil.invokeMethodSafely(sMethodsGetAppActiveNotificationsCount, notificationManager, pkg);
        if (value instanceof Integer) {
            size = (Integer) value;
        }
        return size;
    ...
    public boolean isInSystemRefreshModeDefault() {
        return getSystemRefreshMode() == UPDATE_MODE_DEFAULT;
    }

    @Override
    public boolean isInSystemRefreshModeX() {
        return getSystemRefreshMode() == UPDATE_MODE_X;
    }
}
