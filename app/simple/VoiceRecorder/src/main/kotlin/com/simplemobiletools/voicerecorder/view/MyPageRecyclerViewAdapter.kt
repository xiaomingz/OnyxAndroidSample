...
abstract class MyPageRecyclerViewAdapter<T : ViewDataBinding>(val activity: BaseSimpleActivity, val recyclerView: PageRecyclerView, val fastScroller: FastScroller? = null,
                                         val itemClick: (Any) -> Unit) :  PageRecyclerView.PageAdapter<RecyclerViewBindingViewHolder<T>>() {
