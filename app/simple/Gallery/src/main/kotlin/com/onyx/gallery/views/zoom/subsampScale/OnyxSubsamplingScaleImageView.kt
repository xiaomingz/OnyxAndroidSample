package com.onyx.gallery.views.zoom.subsampScale
 ...
 **/
class OnyxSubsamplingScaleImageView @JvmOverloads constructor(context: Context, attr: AttributeSet? = null) : ImageView(context, attr) {
    companion object {
        const val FILE_SCHEME = "file://"
        const val ASSET_PREFIX = "$FILE_SCHEME/android_asset/"

        private val TAG = OnyxSubsamplingScaleImageView::class.java.simpleName
    ...
    var bitmapDecoderFactory: DecoderFactory<ImageDecoder> = com.davemorrissey.labs.subscaleview.CompatDecoderFactory(com.davemorrissey.labs.subscaleview.SkiaImageDecoder::class.java)
    var regionDecoderFactory: DecoderFactory<ImageRegionDecoder> = com.davemorrissey.labs.subscaleview.CompatDecoderFactory(com.davemorrissey.labs.subscaleview.SkiaImageRegionDecoder::class.java)
    var scale = 0f
    var sWidth = 0
    var sHeight = 0
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (anim != null && anim!!.vFocusStart != null) {
            ...
            var finished = scaleElapsed > anim!!.duration
    ...
    private class TilesInitTask internal constructor(view: OnyxSubsamplingScaleImageView, context: Context, decoderFactory: DecoderFactory<out ImageRegionDecoder>, private val source: Uri) : AsyncTask<Void, Void, IntArray>() {
    ...
    private class TileLoadTask internal constructor(view: OnyxSubsamplingScaleImageView, decoder: ImageRegionDecoder, tile: Tile) : AsyncTask<Void, Void, Bitmap>() {
        private val viewRef = WeakReference(view)
    ...
    class BitmapLoadTask internal constructor(view: OnyxSubsamplingScaleImageView, context: Context, decoderFactory: DecoderFactory<out ImageDecoder>, private val source: Uri) : AsyncTask<Void, Void, Int>() {
        private val viewRef = WeakReference(view)
        private val contextRef = WeakReference(context)
        private val decoderFactoryRef = WeakReference(decoderFactory)
        private var bitmap: Bitmap? = null
