...
package com.onyx.deskclock.alarmclock;
...
public class DigitalAppWidgetProvider extends AppWidgetProvider {
    ...
    private void refreshDate(Context context, RemoteViews widget, float ratio) {
        ...
        final CharSequence timeFormat = Utils.getDatePattern(locale, skeleton);
        ...
        if (Build.VERSION.SDK_INT >= 16){
            ...
            widget.setFloat(R.id.date, "setTextSize", fontSize * ratio);
        }
    }
    ...
    protected void refreshAlarm(Context context, RemoteViews widget, float ratio) {
        ...
        if (!TextUtils.isEmpty(nextAlarm)) {
            ...
            if (Build.VERSION.SDK_INT >= 16){
                ...
                widget.setFloat(R.id.nextAlarm, "setTextSize", fontSize * ratio);
            }
    ...
    private void startAlarmOnQuarterHour(Context context) {
        if (context != null) {
            ...
            if (Build.VERSION.SDK_INT >= 19){
                ...
                am.set(AlarmManager.RTC, onQuarterHour,quarterlyIntent);
            }
            if (DigitalAppWidgetService.LOGGING) {
