...
import com.onyx.deskclock.deskclock.alarms.utils.DayOrderUtils;
...
public final class ExpandedAlarmViewHolder extends AlarmTimeViewHolder {
    ...
    public ExpandedAlarmViewHolder(View itemView,
        ...
        colorStateList = context.getResources().getColorStateList(R.color.alarm_time_checkbox_text_color);
        ...
        vibrate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                alarmTimeClickHandler.setAlarmVibrationEnabled(mAlarm, ((AppCompatCheckBox) v).isChecked());
            }
        });
