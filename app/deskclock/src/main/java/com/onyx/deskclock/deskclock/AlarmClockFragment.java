...
import com.onyx.deskclock.deskclock.alarms.TimePickerCompat;
import com.onyx.deskclock.deskclock.alarms.dataadapter.AlarmTimeAdapter;
import com.onyx.deskclock.deskclock.data.DataModel;
import com.onyx.deskclock.deskclock.provider.Alarm;
import com.onyx.deskclock.deskclock.widget.EmptyViewController;
...
//        mRightButton.setVisibility(View.VISIBLE);
        ...
        mLeftButton.setImageResource(R.drawable.ic_alarm_off_white_48dp);
        mRightButton.setImageResource(R.drawable.ic_alarm_on_white_48dp);
    }
    ...
    public void onLeftButtonClick(View view) {
        ...
        SnackbarManager.show(Snackbar.make(mMainLayout, "Every alarm is disabled!!", Snackbar.LENGTH_LONG));
    }
    ...
    public void onRightButtonClick(View view) {
        ...
        SnackbarManager.show(Snackbar.make(mMainLayout, "Every alarm is enbled!!", Snackbar.LENGTH_LONG));
    }
