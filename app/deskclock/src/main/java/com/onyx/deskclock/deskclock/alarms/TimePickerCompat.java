...
import com.onyx.android.appcompat.datetimepicker.time.RadialPickerLayout;
import com.onyx.android.appcompat.datetimepicker.time.TimePickerDialog;
        ...
        public static TimerPickerPreL newInstance(final Fragment targetFragment, final int hour,
            ...
            dialog.initialize(new OnTimeSetListener() {
                ...
                public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
                    ((TimePickerCompat.OnTimeSetListener) targetFragment).processTimeSet(hourOfDay, minute);
                }
