...
package com.onyx.latinime.latin;

import static com.onyx.latinime.latin.Constants.ImeOption.FORCE_ASCII;
import static com.onyx.latinime.latin.Constants.ImeOption.NO_MICROPHONE;
import static com.onyx.latinime.latin.Constants.ImeOption.NO_MICROPHONE_COMPAT;
...
import com.onyx.latinime.accessibility.AccessibilityUtils;
import com.onyx.latinime.accessibility.AccessibleKeyboardViewProxy;
import com.onyx.latinime.annotations.UsedForTesting;
import com.onyx.latinime.compat.AppWorkaroundsUtils;
import com.onyx.latinime.compat.InputMethodServiceCompatUtils;
import com.onyx.latinime.compat.SuggestionSpanUtils;
import com.onyx.latinime.dictionarypack.DictionaryPackConstants;
import com.onyx.latinime.event.EventInterpreter;
import com.onyx.latinime.keyboard.KeyDetector;
import com.onyx.latinime.keyboard.Keyboard;
import com.onyx.latinime.keyboard.KeyboardActionListener;
import com.onyx.latinime.keyboard.KeyboardId;
import com.onyx.latinime.keyboard.KeyboardSwitcher;
import com.onyx.latinime.keyboard.MainKeyboardView;
import com.onyx.latinime.latin.Suggest.OnGetSuggestedWordsCallback;
import com.onyx.latinime.latin.SuggestedWords.SuggestedWordInfo;
import com.onyx.latinime.latin.define.ProductionFlag;
import com.onyx.latinime.latin.personalization.DictionaryDecayBroadcastReciever;
import com.onyx.latinime.latin.personalization.PersonalizationDictionary;
import com.onyx.latinime.latin.personalization.PersonalizationDictionarySessionRegister;
import com.onyx.latinime.latin.personalization.PersonalizationHelper;
import com.onyx.latinime.latin.personalization.PersonalizationPredictionDictionary;
import com.onyx.latinime.latin.personalization.UserHistoryDictionary;
import com.onyx.latinime.latin.settings.Settings;
import com.onyx.latinime.latin.settings.SettingsActivity;
import com.onyx.latinime.latin.settings.SettingsValues;
import com.onyx.latinime.latin.suggestions.SuggestionStripView;
import com.onyx.latinime.latin.utils.ApplicationUtils;
import com.onyx.latinime.latin.utils.AsyncResultHolder;
import com.onyx.latinime.latin.utils.AutoCorrectionUtils;
import com.onyx.latinime.latin.utils.CapsModeUtils;
import com.onyx.latinime.latin.utils.CollectionUtils;
import com.onyx.latinime.latin.utils.CompletionInfoUtils;
import com.onyx.latinime.latin.utils.InputTypeUtils;
import com.onyx.latinime.latin.utils.IntentUtils;
import com.onyx.latinime.latin.utils.JniUtils;
import com.onyx.latinime.latin.utils.LatinImeLoggerUtils;
import com.onyx.latinime.latin.utils.RecapitalizeStatus;
import com.onyx.latinime.latin.utils.StaticInnerHandlerWrapper;
import com.onyx.latinime.latin.utils.StringUtils;
import com.onyx.latinime.latin.utils.TargetPackageInfoGetterTask;
import com.onyx.latinime.latin.utils.TextRange;
import com.onyx.latinime.latin.utils.UserHistoryForgettingCurveUtils;
