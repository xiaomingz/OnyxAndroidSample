...
public final class CallLogListItemViewHolder extends RecyclerView.ViewHolder
    ...
    private CallLogListItemViewHolder(
        ...
        this.selectCheckBox = (CheckBox) rootView.findViewById(R.id.select_check_box);
    ...
    private void updatePrimaryActionButton(boolean isExpanded) {
        if (!TextUtils.isEmpty(voicemailUri)) {
            ...
            if (PhoneNumberUtil.canPlaceCallsTo(number, numberPresentation) && !selectMode) {
                ...
                primaryActionButtonView.setContentDescription(TextUtils.expandTemplate(
                        ...
                        nameOrNumber));
                primaryActionButtonView.setImageResource(R.drawable.ic_info_outline_24dp);
                primaryActionButtonView.setVisibility(View.VISIBLE);
            } else {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.primary_action_button) {
            ImplicitIntentsUtil.startQuickContact((Activity) mContext, info.lookupUri, ScreenEvent.CALL_LOG_FILTER);
